<%@ include file="/jsp/common/header.jsp" %>
        <form action="<%=request.getContextPath()%>/DoctorServlet?type=add" method="post" id="booking-form">
         <fieldset>
            <div class="clear"></div>
...
<div id="page-heading"><h1>Doctor Entry</h1></div>
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" name="doctorname" class="inp-form"   /></td>
        ...
        <tr>
			...
			<td><input type="date" name="dob" class="inp-form"   /></td>
